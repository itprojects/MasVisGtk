...
class PyPlotWindow(Adw.ApplicationWindow):
    ...
    def on_show_about_dialog(self):
        ...
        self.about.set_translator_credits('ITProjects')
        self.about.set_developers(['ITProjects (2024–)', 'Joakim Fors (2022)'])
        self.about.set_copyright('Copyright 2024 ITProjects\nCopyright 2022 Joakim Fors')
        self.about.set_license_type(Gtk.License.GPL_2_0)
        self.about.set_website('https://github.com/itprojects/MasVisGtk')
